...
const AccountMenu: React.FC<AccountMenuProps> = ({ visible }) => {
    ...
    return (
        <div  css={css`background-color: black; width:200px; position:absolute; top:3rem; right:0;padding:2rem 0; flex-direction:column; border-width:2px; color: #2d3748;  display: flex;`}>
            <div  css={css`width:100%; display: flex; flex-direction: column; gap: 1rem;`}>
                <div  css={css`padding: 0 1rem; display: flex; flex-direction:row; gap: 1rem; align-items:center; width:100%;`}>
                    ...
                    <p  css={css`color: white; font-size: 14px; &:hover {text-decoration: underline;};`}>
                        Username
                    </p>
                </div>
                ...
                <div onClick={() => signOut()} css={css`padding: 0 2rem; text-align:center; color: white; font-size: 14px; &:hover {text-decoration: underline;};`} >
                    Sign out of Netflix
                </div>
            </div>
        </div>
